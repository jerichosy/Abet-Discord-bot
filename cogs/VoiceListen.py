...
class VoiceListen(commands.GroupCog, name="voicelisten"):
    ...
    async def get_vc(self, interaction: discord.Interaction) -> Optional[listening.VoiceClient]:
    ...
    async def stop(self, interaction: discord.Interaction):
        ...
        if interaction.guild.voice_client is None or not (await self.get_vc(interaction)).is_listen_receiving():
